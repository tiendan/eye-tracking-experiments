...
jsPsych.plugins["html-button-response"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      skip_if_calibration_validated: {
        type: jsPsych.plugins.parameterType.BOOL,
        pretty_name: 'Skip if calibration is validated',
        default: false,
        description: 'Skip this trial if the calibration does not need validation.'
      },
    }
  }

  plugin.trial = function(display_element, trial) {
    if (trial.skip_if_calibration_validated && window.needs_validation !== true) {
            jsPsych.finishTrial();
            return;
    }
    // display stimulus
